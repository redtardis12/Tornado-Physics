...
public class Config {
    ...
    public static final ModConfigSpec.DoubleValue SAIL_LIFT;
    ...
    static {
        ...
        SAIL_LIFT = BUILDER
                .comment("Lift generated by sails in the wind")
                .translation("tornadophysics.config.wind.sailLift")
                .defineInRange("sailLift", 1.0, 0.0, 10000.0);
